...
public class GameManager : MonoBehaviour
{
    ...
    public void ChangeLineToTram()
    {
        GameObject.Find("LineCreator").GetComponent<LineCreator>().mode = 1;
    }
    public void ChangeLineToNormal()
    {
        GameObject.Find("LineCreator").GetComponent<LineCreator>().mode = 0;
    }
    public void ChangeErase()
    {
        GameObject.Find("LineCreator").GetComponent<LineCreator>().mode = 2;
    }
}
